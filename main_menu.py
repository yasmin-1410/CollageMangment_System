...
def library_menu():
    while True:
        ...
        if y == 1:
            id = int(input("Enter id : "))
            lib.LibraryDetails(id)
        elif y == 2:
            while True:
                name = input("Enter name : ")
                lib.SearchBooks(name)
                again = input("Do you want to check another book? (Y/N): ").strip().upper()
                if again != 'Y':
                    break
        elif y == 3:
            while True:
                name = input("Enter name : ")
                lib.LendBooks(name)
                again = input("Do you want to lend another book? (Y/N): ").strip().upper()
                if again != 'Y':
                    break
        elif y == 4:
            while True:
                name = input("Enter name : ")
                lib.ReturnBooks(name)
                again = input("Do you want to return another book? (Y/N): ").strip().upper()
                if again != 'Y':
                    break
        elif y == 5:
            break
    ...
    while True:
        ...
        if y == 1:
            while True:
                id = int(input("Enter id : "))
                bus.BusDitails(id)
                again = input("Do you want to check another bus? (Y/N): ").strip().upper()
                if again != 'Y':
                    break
        elif y == 2:
            while True:
                id = int(input("Enter id : "))
                bus.SeatsAvailability(id)
                again = input("Do you want to check another bus? (Y/N): ").strip().upper()
                if again != 'Y':
                    break
        elif y == 3:
            ...
            with open("Auditorium.txt", 'r') as file:
                for line in file:
                    ...
                    if len(parts) == 3:
                        ...
                        print(f"Auditorium ID : {event_id}")
                        print(f"Auditorium Name : {auditorium_event_name}")
                        print(f"Auditorium Total Seats : {auditorium_total_seats}")
                        print()
                        
            name = input("Enter Name : ")
            date = input("Enter date: ")
            time = input("Enter time: ")
            total = int(input("Enter seats: "))
            aud.BookEvents(name,date,time,total)
